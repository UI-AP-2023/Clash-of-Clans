...
//    }
    ...
    //---------------building attack------------------------------------------------------------------------------------
//    public void buildingAttack(ArrayList<Hero> heroes,Building building) {
//        TranslateTransition transition = new TranslateTransition();
//        transition.setDuration(Duration.millis(1000));
//        double min = Double.MAX_EXPONENT;
//        for (Hero h : heroes) {
//            deltaX = h.getHeroImage().getLayoutX() - building.getImageView().getLayoutX();
//            deltaY = h.getHeroImage().getLayoutY() - building.getImageView().getLayoutY();
//            if (Math.sqrt(Math.pow(deltaX, 2) + Math.pow(deltaY, 2)) < min) {
//                min = Math.sqrt(Math.pow(deltaX, 2) + Math.pow(deltaY, 2));
//                resultX = Math.abs(h.getHeroImage().getLayoutX() - building.getImageView().getLayoutX());
//                resultY = Math.abs(h.getHeroImage().getLayoutY() - building.getImageView().getLayoutY());
//                if (h.getHeroImage().getLayoutX() - building.getImageView().getLayoutX() < 0 && h.getHeroImage().getLayoutY() - building.getImageView().getLayoutY() > 0) {
//                    negativeX = true;
//                    negativeY = false;
//                } else if (h.getHeroImage().getLayoutX() - building.getImageView().getLayoutX() > 0 && h.getHeroImage().getLayoutY() - building.getImageView().getLayoutY() < 0) {
//                    negativeY = true;
//                    negativeX = false;
//                } else if (h.getHeroImage().getLayoutX() - building.getImageView().getLayoutX() < 0 && h.getHeroImage().getLayoutY() - building.getImageView().getLayoutY() < 0) {
//                    negativeY = true;
...
//            }
//        }
//        building.getArrow().setVisible(true);
//        building.getArrow().setLayoutX(building.getImageView().getLayoutX() + 20);
//        building.getArrow().setLayoutY(building.getImageView().getLayoutY() + 30);
//        transition.setNode(building.getArrow());
//        System.out.println("MIN:" + min);
//        if (negativeX) {
//            resultX = -resultX;
//        }
...
//        transition.play();
//
//        if (target2(building.getArrow(), nearestBuilding)) {
//            try {
//                attack3(anchorPane, hero, nearestBuilding, buildings, mapID);
//            } catch (InterruptedException e) {
//                e.printStackTrace();
...
//    public boolean target2(ImageView imageView, Building building) {
//        System.out.println((Math.sqrt(Math.pow((imageView.getBoundsInLocal().getCenterY() - building.getImageView().getBoundsInLocal().getCenterY()), 2) + Math.pow((imageView.getBoundsInLocal().getCenterX() - building.getBoundsInLocal().getCenterX()), 2))));
//        System.out.println("b:" + (imageView.getBoundsInLocal().getCenterY() - building.getImageView().getBoundsInLocal().getCenterY()));
//        System.out.println("v:" + (imageView.getLayoutY() - building.getImageView().getLayoutY()));
//        if (Math.abs(imageView.getBoundsInParent().getMaxY() - building.getImageView().getBoundsInParent().getMaxY())<=20) {
//            return true;
//        }
//        if (Math.abs(imageView.getBoundsInParent().getMaxX() - building.getImageView().getBoundsInParent().getMaxX())<=20) {
//            return true;
//        }
//        if (Math.abs(imageView.getBoundsInParent().getMinX() - building.getImageView().getBoundsInParent().getMinX())<=20) {
//            return true;
//        }
//        if (Math.abs(imageView.getBoundsInParent().getMinY() - building.getImageView().getBoundsInParent().getMinY())<=20) {
//            return true;
//        }
//        return false;
//    }
